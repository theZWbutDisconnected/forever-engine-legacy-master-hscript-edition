		...
		if (accepted)
		{
			...
			switch (daSelected)
			{
				...
				case "Restart Song":
					...
					if (Stage.stageHandler.exists("onRestartSong"))
						Stage.stageHandler.get("onRestartSong")();

					if (Character.scriptHandler.exists("onRestartSong"))
						Character.scriptHandler.get("onRestartSong")();
				case "Exit to menu":
